...
{
    public partial class RFMS : Form
    {
        ...
        public RFMS()
        {
            ...
            this.FormClosing += new FormClosingEventHandler(RFMS_FormClosing);
        ...
        private void RFMS_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM [dbo].[MS]", connection);
        ...
        public void LoadData()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string countQuery = "SELECT COUNT(*) FROM MS ";
                ...
                if (allData.Rows.Count <= rowCount)
                {
                    ...
                    string query = "SELECT * FROM MS ORDER BY id_MS DESC  OFFSET @Offset ROWS FETCH NEXT @Limit ROWS ONLY";
        ...
        private void RFMS_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (Application.OpenForms.OfType<MRFMS>().Any())
            {
                // Fermer la Form MRFMR
                MRFMS mRFMS = Application.OpenForms.OfType<MRFMS>().FirstOrDefault();
                mRFMS.Close();
            }
        }
        private MRFMS formInstance = null;
        private void button2_Click(object sender, EventArgs e)
        {
            if (formInstance == null)
            {
                formInstance = new MRFMS(this);
                formInstance.FormClosed += (s, args) => formInstance = null;
            }
            if (dataGridView1.SelectedRows.Count > 0)
            {
                int selectedId = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["id_MS"].Value);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                int idToDelete = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["id_MS"].Value); // Remplacer "Id" par le nom de votre colonne contenant l'identifiant unique
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    string query = "DELETE FROM MS WHERE id_MS = @id"; // Remplacer "MaTable" par le nom de votre table et "Id" par le nom de votre colonne d'identifiant unique
        ...
        private MRFMS formInstance1 = null;
        private void button1_Click(object sender, EventArgs e)
        {
            if (formInstance1 == null)
            {
                formInstance1 = new MRFMS(this);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.TryParse(searchTerm, out DateTime searchDate))
            {
                ...
                string sql = "SELECT * FROM MS WHERE Date_de_la_réclamation  = '" + searchTerm + "'";
            ...
            {
                string sql = "SELECT * FROM MS WHERE N_de_la_NC = '" + searchTerm + "' OR N_de_doc  = '" + searchTerm + "'OR Client  = '" + searchTerm + "'OR Fournisseur  = '" + searchTerm + "'";
                using (var adapter = new SqlDataAdapter(sql, connection))
                {
                    DataTable dt = new DataTable();
                    adapter.Fill(dt);
        ...
        private void RFMS_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private MRFMS formInstance2 = null;
        private void button10_Click(object sender, EventArgs e)
        {
            if (formInstance2 == null)
            {
                formInstance2 = new MRFMS(this);
