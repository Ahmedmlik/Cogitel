...
namespace Cogitel_QT
{
    public partial class MRFMS : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command1 = new SqlCommand("SELECT TOP 1 * FROM MS", connection);
        ...
        private void MRFMS_Load(object sender, EventArgs e)
        {
